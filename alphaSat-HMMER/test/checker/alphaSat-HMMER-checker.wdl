...
import "../../alphaSat-HMMER.wdl" as alphaSat_HMMER

workflow checker_alphaSat_HMMER {
	input {
		# workflow inputs
	...
	call alphaSat_HMMER.alphaSat_HMMER as alphaSat_HMMER {
		input:
	...
	Array[File] aggregate_output = [alphaSat_HMMER.as_hor_sf_bed, alphaSat_HMMER.as_strand_bed, 
									alphaSat_HMMER.as_hor_bed, alphaSat_HMMER.as_sf_bed]
